---
title: 'Weathering the Storm: Identifying severe weather classifiers that are most
  detrimental to health and economy in the USA'
author: "A Evans"
...
output:
  ...
  html_document:
    keep_md: yes
subtitle: 'Coursera Reproducible Research Project 2: Exploration of (NOAA) storm database'
...
|-----|----------------|-----|----------------|-----|----------------|-----|----------------|
| 01  | `r events[1]`  | 13  | `r events[13]` | 25  | `r events[25]` | 37  | `r events[37]` |
| 02  | `r events[2]`  | 14  | `r events[14]` | 26  | `r events[26]` | 38  | `r events[38]` |
| 03  | `r events[3]`  | 15  | `r events[15]` | 27  | `r events[27]` | 39  | `r events[39]` |
| 04  | `r events[4]`  | 16  | `r events[16]` | 28  | `r events[28]` | 40  | `r events[40]` |
| 05  | `r events[5]`  | 17  | `r events[17]` | 29  | `r events[29]` | 41  | `r events[41]` |
| 06  | `r events[6]`  | 18  | `r events[18]` | 30  | `r events[30]` | 42  | `r events[42]` |
| 07  | `r events[7]`  | 19  | `r events[19]` | 31  | `r events[31]` | 43  | `r events[43]` |
| 08  | `r events[8]`  | 20  | `r events[20]` | 32  | `r events[32]` | 44  | `r events[44]` |
| 09  | `r events[9]`  | 21  | `r events[21]` | 33  | `r events[33]` | 45  | `r events[45]` |
| 10  | `r events[10]` | 22  | `r events[22]` | 34  | `r events[34]` | 46  | `r events[46]` |
| 11  | `r events[11]` | 23  | `r events[23]` | 35  | `r events[35]` | 47  | `r events[47]` |
| 12  | `r events[12]` | 24  | `r events[24]` | 36  | `r events[36]` | 48  | `r events[48]` |
...
|------|-----------------------------------|-------------------------------------------|--------------------------------------|--------------------------------------------|
| 1    | `r eventTotFatalSmeth1$event[1]`  | `r eventTotFatalSmeth1$fatalities_fmt[1]` | `r eventTotInjuriesSmeth1$event[1]`  | `r eventTotInjuriesSmeth1$injuries_fmt[1]` |
| 2    | -                                 | -                                         | -                                    | -                                          |
...
| Rank | Event                             | Total No. Fatalities                       |  Event                               | Total No. Injured                           |
|------|-----------------------------------|--------------------------------------------|--------------------------------------|---------------------------------------------|
| 1    | `r eventTotFatalSmeth2$event[1]`  | `r eventTotFatalSmeth2$fatalities_fmt[1]`  | `r eventTotInjuriesSmeth2$event[1]`  | `r eventTotInjuriesSmeth2$injuries_fmt[1]`  |
| 2    | `r eventTotFatalSmeth2$event[2]`  | `r eventTotFatalSmeth2$fatalities_fmt[2]`  | `r eventTotInjuriesSmeth2$event[2]`  | `r eventTotInjuriesSmeth2$injuries_fmt[2]`  | 
| 3    | `r eventTotFatalSmeth2$event[3]`  | `r eventTotFatalSmeth2$fatalities_fmt[3]`  | `r eventTotInjuriesSmeth2$event[3]`  | `r eventTotInjuriesSmeth2$injuries_fmt[3]`  |
| 4    | `r eventTotFatalSmeth2$event[4]`  | `r eventTotFatalSmeth2$fatalities_fmt[4]`  | `r eventTotInjuriesSmeth2$event[4]`  | `r eventTotInjuriesSmeth2$injuries_fmt[4]`  |
| 5    | `r eventTotFatalSmeth2$event[5]`  | `r eventTotFatalSmeth2$fatalities_fmt[5]`  | `r eventTotInjuriesSmeth2$event[5]`  | `r eventTotInjuriesSmeth2$injuries_fmt[5]`  |
| 6    | `r eventTotFatalSmeth2$event[6]`  | `r eventTotFatalSmeth2$fatalities_fmt[6]`  | `r eventTotInjuriesSmeth2$event[6]`  | `r eventTotInjuriesSmeth2$injuries_fmt[6]`  |
| 7    | `r eventTotFatalSmeth2$event[7]`  | `r eventTotFatalSmeth2$fatalities_fmt[7]`  | `r eventTotInjuriesSmeth2$event[7]`  | `r eventTotInjuriesSmeth2$injuries_fmt[7]`  |        
| 8    | `r eventTotFatalSmeth2$event[8]`  | `r eventTotFatalSmeth2$fatalities_fmt[8]`  | `r eventTotInjuriesSmeth2$event[8]`  | `r eventTotInjuriesSmeth2$injuries_fmt[8]`  |
| 9    | `r eventTotFatalSmeth2$event[9]`  | `r eventTotFatalSmeth2$fatalities_fmt[9]`  | `r eventTotInjuriesSmeth2$event[9]`  | `r eventTotInjuriesSmeth2$injuries_fmt[9]`  |
| 10   | `r eventTotFatalSmeth2$event[10]` | `r eventTotFatalSmeth2$fatalities_fmt[10]` | `r eventTotInjuriesSmeth2$event[10]` | `r eventTotInjuriesSmeth2$injuries_fmt[10]` |    
...
| Rank | Event                             | Total No. Fatalities                       |  Event                               | Total No. Injured                           |
|------|-----------------------------------|--------------------------------------------|--------------------------------------|---------------------------------------------|
| 1    | `r eventTotFatalSmeth3$event[1]`  | `r eventTotFatalSmeth3$fatalities_fmt[1]`  | `r eventTotInjuriesSmeth3$event[1]`  | `r eventTotInjuriesSmeth3$injuries_fmt[1]`  |
| 2    | `r eventTotFatalSmeth3$event[2]`  | `r eventTotFatalSmeth3$fatalities_fmt[2]`  | `r eventTotInjuriesSmeth3$event[2]`  | `r eventTotInjuriesSmeth3$injuries_fmt[2]`  | 
| 3    | `r eventTotFatalSmeth3$event[3]`  | `r eventTotFatalSmeth3$fatalities_fmt[3]`  | `r eventTotInjuriesSmeth3$event[3]`  | `r eventTotInjuriesSmeth3$injuries_fmt[3]`  |
| 4    | `r eventTotFatalSmeth3$event[4]`  | `r eventTotFatalSmeth3$fatalities_fmt[4]`  | `r eventTotInjuriesSmeth3$event[4]`  | `r eventTotInjuriesSmeth3$injuries_fmt[4]`  |
| 5    | `r eventTotFatalSmeth3$event[5]`  | `r eventTotFatalSmeth3$fatalities_fmt[5]`  | `r eventTotInjuriesSmeth3$event[5]`  | `r eventTotInjuriesSmeth3$injuries_fmt[5]`  |
| 6    | `r eventTotFatalSmeth3$event[6]`  | `r eventTotFatalSmeth3$fatalities_fmt[6]`  | `r eventTotInjuriesSmeth3$event[6]`  | `r eventTotInjuriesSmeth3$injuries_fmt[6]`  |
| 7    | `r eventTotFatalSmeth3$event[7]`  | `r eventTotFatalSmeth3$fatalities_fmt[7]`  | `r eventTotInjuriesSmeth3$event[7]`  | `r eventTotInjuriesSmeth3$injuries_fmt[7]`  |        
| 8    | `r eventTotFatalSmeth3$event[8]`  | `r eventTotFatalSmeth3$fatalities_fmt[8]`  | `r eventTotInjuriesSmeth3$event[8]`  | `r eventTotInjuriesSmeth3$injuries_fmt[8]`  |
| 9    | `r eventTotFatalSmeth3$event[9]`  | `r eventTotFatalSmeth3$fatalities_fmt[9]`  | `r eventTotInjuriesSmeth3$event[9]`  | `r eventTotInjuriesSmeth3$injuries_fmt[9]`  |
| 10   | `r eventTotFatalSmeth3$event[10]` | `r eventTotFatalSmeth3$fatalities_fmt[10]` | `r eventTotInjuriesSmeth3$event[10]` | `r eventTotInjuriesSmeth3$injuries_fmt[10]` |    
...
| Rank | Event                                  | Total Crop Damages USD                          |  Event                                 | Total Property Damages UDF                      | 
|------|----------------------------------------|-------------------------------------------------|----------------------------------------|-------------------------------------------------|
| 1    | `r eventTotCropdmgusdSmeth2$event[1]`  | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[1]`  | `r eventTotPropdmgusdSmeth2$event[1]`  | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[1]`  |
| 2    | `r eventTotCropdmgusdSmeth2$event[2]`  | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[2]`  | `r eventTotPropdmgusdSmeth2$event[2]`  | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[2]`  |
| 3    | `r eventTotCropdmgusdSmeth2$event[3]`  | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[3]`  | `r eventTotPropdmgusdSmeth2$event[3]`  | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[3]`  |
| 4    | `r eventTotCropdmgusdSmeth2$event[4]`  | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[4]`  | `r eventTotPropdmgusdSmeth2$event[4]`  | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[4]`  |
| 5    | `r eventTotCropdmgusdSmeth2$event[5]`  | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[5]`  | `r eventTotPropdmgusdSmeth2$event[5]`  | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[5]`  |
| 6    | `r eventTotCropdmgusdSmeth2$event[6]`  | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[6]`  | `r eventTotPropdmgusdSmeth2$event[6]`  | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[6]`  |
| 7    | `r eventTotCropdmgusdSmeth2$event[7]`  | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[7]`  | `r eventTotPropdmgusdSmeth2$event[7]`  | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[7]`  |
| 8    | `r eventTotCropdmgusdSmeth2$event[8]`  | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[8]`  | `r eventTotPropdmgusdSmeth2$event[8]`  | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[8]`  |
| 9    | `r eventTotCropdmgusdSmeth2$event[9]`  | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[9]`  | `r eventTotPropdmgusdSmeth2$event[9]`  | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[9]`  |
| 10   | `r eventTotCropdmgusdSmeth2$event[10]` | `r eventTotCropdmgusdSmeth2$cropdmgusd_fmt[10]` | `r eventTotPropdmgusdSmeth2$event[10]` | `r eventTotPropdmgusdSmeth2$propdmgusd_fmt[10]` |
...
| Rank | Event                                  | Total Crop Damages USD                          |  Event                                 | Total Property Damages UDF                      | 
|------|----------------------------------------|-------------------------------------------------|----------------------------------------|-------------------------------------------------|
| 1    | `r eventTotCropdmgusdSmeth3$event[1]`  | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[1]`  | `r eventTotPropdmgusdSmeth3$event[1]`  | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[1]`  |
| 2    | `r eventTotCropdmgusdSmeth3$event[2]`  | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[2]`  | `r eventTotPropdmgusdSmeth3$event[2]`  | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[2]`  |
| 3    | `r eventTotCropdmgusdSmeth3$event[3]`  | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[3]`  | `r eventTotPropdmgusdSmeth3$event[3]`  | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[3]`  |
| 4    | `r eventTotCropdmgusdSmeth3$event[4]`  | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[4]`  | `r eventTotPropdmgusdSmeth3$event[4]`  | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[4]`  |
| 5    | `r eventTotCropdmgusdSmeth3$event[5]`  | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[5]`  | `r eventTotPropdmgusdSmeth3$event[5]`  | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[5]`  |
| 6    | `r eventTotCropdmgusdSmeth3$event[6]`  | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[6]`  | `r eventTotPropdmgusdSmeth3$event[6]`  | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[6]`  |
| 7    | `r eventTotCropdmgusdSmeth3$event[7]`  | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[7]`  | `r eventTotPropdmgusdSmeth3$event[7]`  | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[7]`  |
| 8    | `r eventTotCropdmgusdSmeth3$event[8]`  | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[8]`  | `r eventTotPropdmgusdSmeth3$event[8]`  | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[8]`  |
| 9    | `r eventTotCropdmgusdSmeth3$event[9]`  | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[9]`  | `r eventTotPropdmgusdSmeth3$event[9]`  | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[9]`  |
| 10   | `r eventTotCropdmgusdSmeth3$event[10]` | `r eventTotCropdmgusdSmeth3$cropdmgusd_fmt[10]` | `r eventTotPropdmgusdSmeth3$event[10]` | `r eventTotPropdmgusdSmeth3$propdmgusd_fmt[10]` |
...
|------|--------------------------------|-----------------------------------------|---------------------------------------|--------------------------------------|
| 1    | `r eventTothealthss$event[1]`  | `r eventTothealthss$fatalities_fmt[1]`  | `r eventTothealthss$injuries_fmt[1]`  | `r eventTothealthss$totindv_fmt[1]`  |
| 2    | `r eventTothealthss$event[2]`  | `r eventTothealthss$fatalities_fmt[2]`  | `r eventTothealthss$injuries_fmt[2]`  | `r eventTothealthss$totindv_fmt[2]`  |
| 3    | `r eventTothealthss$event[3]`  | `r eventTothealthss$fatalities_fmt[3]`  | `r eventTothealthss$injuries_fmt[3]`  | `r eventTothealthss$totindv_fmt[3]`  |
| 4    | `r eventTothealthss$event[4]`  | `r eventTothealthss$fatalities_fmt[4]`  | `r eventTothealthss$injuries_fmt[4]`  | `r eventTothealthss$totindv_fmt[4]`  |
| 5    | `r eventTothealthss$event[5]`  | `r eventTothealthss$fatalities_fmt[5]`  | `r eventTothealthss$injuries_fmt[5]`  | `r eventTothealthss$totindv_fmt[5]`  |
| 6    | `r eventTothealthss$event[6]`  | `r eventTothealthss$fatalities_fmt[6]`  | `r eventTothealthss$injuries_fmt[6]`  | `r eventTothealthss$totindv_fmt[6]`  |
| 7    | `r eventTothealthss$event[7]`  | `r eventTothealthss$fatalities_fmt[7]`  | `r eventTothealthss$injuries_fmt[7]`  | `r eventTothealthss$totindv_fmt[7]`  |
| 8    | `r eventTothealthss$event[8]`  | `r eventTothealthss$fatalities_fmt[8]`  | `r eventTothealthss$injuries_fmt[8]`  | `r eventTothealthss$totindv_fmt[8]`  |
| 9    | `r eventTothealthss$event[9]`  | `r eventTothealthss$fatalities_fmt[9]`  | `r eventTothealthss$injuries_fmt[9]`  | `r eventTothealthss$totindv_fmt[9]`  |
| 10   | `r eventTothealthss$event[10]` | `r eventTothealthss$fatalities_fmt[10]` | `r eventTothealthss$injuries_fmt[10]` | `r eventTothealthss$totindv_fmt[10]` |
...
|------|--------------------------------|-----------------------------------------|-----------------------------------------|-------------------------------------|
| 1    | `r eventTotdamagess$event[1]`  | `r eventTotdamagess$cropdmgusd_fmt[1]`  | `r eventTotdamagess$propdmgusd_fmt[1]`  | `r eventTotdamagess$totusd_fmt[1]`  |
| 2    | `r eventTotdamagess$event[2]`  | `r eventTotdamagess$cropdmgusd_fmt[2]`  | `r eventTotdamagess$propdmgusd_fmt[2]`  | `r eventTotdamagess$totusd_fmt[2]`  |
| 3    | `r eventTotdamagess$event[3]`  | `r eventTotdamagess$cropdmgusd_fmt[3]`  | `r eventTotdamagess$propdmgusd_fmt[3]`  | `r eventTotdamagess$totusd_fmt[3]`  |
| 4    | `r eventTotdamagess$event[4]`  | `r eventTotdamagess$cropdmgusd_fmt[4]`  | `r eventTotdamagess$propdmgusd_fmt[4]`  | `r eventTotdamagess$totusd_fmt[4]`  |
| 5    | `r eventTotdamagess$event[5]`  | `r eventTotdamagess$cropdmgusd_fmt[5]`  | `r eventTotdamagess$propdmgusd_fmt[5]`  | `r eventTotdamagess$totusd_fmt[5]`  |
| 6    | `r eventTotdamagess$event[6]`  | `r eventTotdamagess$cropdmgusd_fmt[6]`  | `r eventTotdamagess$propdmgusd_fmt[6]`  | `r eventTotdamagess$totusd_fmt[6]`  |
| 7    | `r eventTotdamagess$event[7]`  | `r eventTotdamagess$cropdmgusd_fmt[7]`  | `r eventTotdamagess$propdmgusd_fmt[7]`  | `r eventTotdamagess$totusd_fmt[7]`  |
| 8    | `r eventTotdamagess$event[8]`  | `r eventTotdamagess$cropdmgusd_fmt[8]`  | `r eventTotdamagess$propdmgusd_fmt[8]`  | `r eventTotdamagess$totusd_fmt[8]`  |
| 9    | `r eventTotdamagess$event[9]`  | `r eventTotdamagess$cropdmgusd_fmt[9]`  | `r eventTotdamagess$propdmgusd_fmt[9]`  | `r eventTotdamagess$totusd_fmt[9]`  |
| 10   | `r eventTotdamagess$event[10]` | `r eventTotdamagess$cropdmgusd_fmt[10]` | `r eventTotdamagess$propdmgusd_fmt[10]` | `r eventTotdamagess$totusd_fmt[10]` |
